    ...
    return (
        <GlassCard className="p-6">
            <div className="flex flex-col items-center text-center">
                ...
                <div className="mb-4 h-16 w-16 flex items-center justify-center rounded-full bg-zinc-900/80 border border-white/5 shadow-inner">
                    <Crosshair className="w-8 h-8 text-emerald-500" strokeWidth={2} />
                </div>
